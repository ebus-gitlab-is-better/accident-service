...
// @BasePath	/
func NewHTTPServer(c *conf.Server, accident *route.AccidentRoute,
	...
	accidentG := r.Group("/accident")
	accidentG.Use(AuthMiddleware(keycloak))
	accident.Register(accidentG)
